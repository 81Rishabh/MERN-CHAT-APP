    ...
    <div className="container  w-96 bg-white absolute top-2/4 left-2/4 left-50 py-5 rounded-md -translate-y-2/4 -translate-x-2/4">
      <div className="card">
        ...
        <form
          ...
          className="flex flex-col px-4 py-3 w-11/12 m-auto"
        >
          ...
          <button
            type="submit"
            className="relative flex items-center justify-center bg-indigo-500 w-11/12 py-2 mt-2 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-md shadow-md cursor-pointer hover:scale-95 transition duration-100"
        ...
        <div className="footer text-center">
          <p className="footer-left-text text-gray-500">
            ...
            <Link to="/SignUp" className="text-indigo-700 font-medium">
              SignUp
            </Link>
          </p>
        </div>
...
// {!loading && <div className="w-5 h-5 animate-spin border-4 border-slate-300 border-t-slate-100  rounded-full ml-2"></div>}  